...
public abstract class AbstractRealmImpl implements Realm {
    ...
    public abstract RemotingServicePrincipal authenticate(String userid,
            String password);

    public abstract boolean hasRole(RemotingServicePrincipal principal,
            String role);
    ...
    protected final RemotingServicePrincipal createPrincipal(final String userid, final String role) {
