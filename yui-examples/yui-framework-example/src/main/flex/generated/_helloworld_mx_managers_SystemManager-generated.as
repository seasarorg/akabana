    ...
    implements IFlexModuleFactory
{
    ...
    override    public function info():Object
    {
        return {
            ...
            mixins: [ "_helloworld_FlexInit", "_alertButtonStyleStyle", "_ControlBarStyle", "_ScrollBarStyle", "_activeTabStyleStyle", "_textAreaHScrollBarStyleStyle", "_ToolTipStyle", "_DragManagerStyle", "_comboDropdownStyle", "_textAreaVScrollBarStyleStyle", "_YuiFrameworkSettingsStyle", "_ContainerStyle", "_linkButtonStyleStyle", "_globalStyle", "_windowStatusStyle", "_PanelStyle", "_windowStylesStyle", "_activeButtonStyleStyle", "_errorTipStyle", "_richTextEditorTextAreaStyleStyle", "_CursorManagerStyle", "_todayStyleStyle", "_TextInputStyle", "_dateFieldPopupStyle", "_plainStyle", "_dataGridStylesStyle", "_customizersStyle", "_ApplicationStyle", "_headerDateTextStyle", "_ButtonStyle", "_popUpMenuStyle", "_AlertStyle", "_swatchPanelTextFieldStyle", "_opaquePanelStyle", "_weekDayStyleStyle", "_RadioButtonStyle", "_headerDragProxyStyleStyle", "org.seasar.akabana.yui.framework.mixin.YuiFrameworkMixin", "_examples_yui_helloworld_view_HelloWorldViewWatcherSetupUtil" ],
