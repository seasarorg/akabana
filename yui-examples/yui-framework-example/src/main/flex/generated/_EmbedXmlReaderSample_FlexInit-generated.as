...
[Mixin]
public class _EmbedXmlReaderSample_FlexInit
{
   public function _EmbedXmlReaderSample_FlexInit()
   {
       super();
   }
   public static function init(fbs:IFlexModuleFactory):void
   {
      ...
      if (flash.net.getClassByAlias("flex.messaging.io.ObjectProxy") == null){
          ...
          flash.net.registerClassAlias("flex.messaging.io.ObjectProxy", mx.utils.ObjectProxy); }
      var styleNames:Array = ["fontAntiAliasType", "errorColor", "kerning", "backgroundDisabledColor", "modalTransparencyColor", "textRollOverColor", "textIndent", "themeColor", "modalTransparency", "textDecoration", "dividerColor", "headerColors", "fontThickness", "textAlign", "fontFamily", "depthColors", "textSelectedColor", "selectionDisabledColor", "fontGridFitType", "letterSpacing", "rollOverColor", "fontStyle", "dropShadowColor", "fontSize", "selectionColor", "disabledColor", "fontWeight", "modalTransparencyBlur", "leading", "color", "alternatingItemColors", "fontSharpness", "barColor", "modalTransparencyDuration", "footerColors"];
