...
public class _Main_FlexInit
{
   ...
   public static function init(fbs:IFlexModuleFactory):void
   {
      ...
      try {
      if (flash.net.getClassByAlias("root.yui.example.entity.Emp") == null){
          flash.net.registerClassAlias("root.yui.example.entity.Emp", examples.yui.employee.entity.Emp);}
      } catch (e:Error) {
          flash.net.registerClassAlias("root.yui.example.entity.Emp", examples.yui.employee.entity.Emp); }
      try {
      ...
      if (flash.net.getClassByAlias("flex.messaging.io.ObjectProxy") == null){
          ...
          flash.net.registerClassAlias("flex.messaging.io.ObjectProxy", mx.utils.ObjectProxy); }
      var styleNames:Array = ["fontWeight", "modalTransparencyBlur", "rollOverColor", "textRollOverColor", "verticalGridLineColor", "backgroundDisabledColor", "textIndent", "barColor", "fontSize", "kerning", "footerColors", "textAlign", "disabledIconColor", "fontStyle", "modalTransparencyDuration", "textSelectedColor", "todayColor", "horizontalGridLineColor", "selectionColor", "modalTransparency", "fontGridFitType", "selectionDisabledColor", "disabledColor", "fontAntiAliasType", "modalTransparencyColor", "alternatingItemColors", "leading", "iconColor", "dropShadowColor", "themeColor", "letterSpacing", "fontFamily", "color", "fontThickness", "errorColor", "headerColors", "fontSharpness", "textDecoration"];
