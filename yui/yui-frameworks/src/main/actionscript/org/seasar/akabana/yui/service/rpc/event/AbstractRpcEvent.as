...
package org.seasar.akabana.yui.service.rpc.event {
    ...
    internal class AbstractRpcEvent extends Event {
        ...
        public function AbstractRpcEvent( type:String, pendigCall:PendingCall, bubbles:Boolean = false, cancelable:Boolean = false ){
            super(type,bubbles,cancelable);
            pendigCall_ = pendigCall;
        }
        
        public function get pendigCall():PendingCall{
            return pendigCall_;
        }
    }
}