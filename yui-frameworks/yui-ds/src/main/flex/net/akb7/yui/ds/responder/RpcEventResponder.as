 ...
 */
package net.akb7.yui.ds.responder {
    ...
    public final class RpcEventResponder extends AbstractRpcEventResponder {
        ...
        public override function result(data:Object):void
        {
            ...
            var newEvent:net.akb7.yui.service.event.ResultEvent = new net.akb7.yui.service.event.ResultEvent(result);
        ...
        public override function fault(info:Object):void
        {
            if( faultFunction != null ){
                ...
                var newEvent:net.akb7.yui.service.event.FaultEvent = new net.akb7.yui.service.event.FaultEvent(faultStatus);
