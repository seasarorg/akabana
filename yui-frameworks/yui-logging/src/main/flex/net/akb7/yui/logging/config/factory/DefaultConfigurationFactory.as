 ...
 */
package net.akb7.yui.logging.config.factory
{
    import net.akb7.yui.logging.appender.SimpleAppender;
    import net.akb7.yui.logging.category.SimpleCategory;
    ...
    import net.akb7.yui.logging.config.LevelConfig;
    import net.akb7.yui.logging.config.ParamConfig;
    import net.akb7.yui.logging.layout.BasicPatternLayout;
