 ...
 */
package net.akb7.yui.rpc.responder {
    ...
    public final class RpcObjectResponder extends AbstractRpcEventResponder {
        ...
        public function RpcObjectResponder( resultFunction:Function, faultFunction:Function = null, weakReference:Boolean=false){
            super(resultFunction,faultFunction,weakReference);
        }

        public override function onResult( result:ResultEvent ):void{
            callResultFunction(result.result);
        }

        public override function onFault( fault:FaultEvent ):void{
            callFaultFunction(fault.faultStatus);
        }
    }
}